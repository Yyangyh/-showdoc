        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    item.appendChild($("<span class='delbtn' alt='" + list[i].alt + "'></span>").click(function (){
          var del = $(this);
          try {
          ...
          $.post("https://test.dascomyun.cn/dswifitools/delImagesByPath", "path="+del.attr("alt"),
          function (result) {
//            console(result)
          if (result.rscode==1501) {
          
          console.log(del.attr("alt"))
          del.parent().remove();
          }
